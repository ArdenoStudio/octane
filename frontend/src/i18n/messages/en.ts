...
export const EN: Messages = {
  ...
  prices: {
    badge: "Live prices · CPC & Lanka IOC",
    title: "Sri Lanka fuel prices, today.",
    lastRevision: "Last revision",
    lastChecked: "Last checked",
    revisedToday: "Prices revised today",
    earlySignalTitle: "Reported ahead of official",
    earlySignalNews: "News",
    earlySignalLioc: "Lanka IOC",
    earlySignalUnconfirmed: "Unconfirmed — awaiting official revision",
    ...
    filterAll: "All",
    filterOfficialOnly: "Official only",
    awaitingData: "Awaiting data",
    lkrPer: "LKR ·",
    loadError: "Couldn't load prices. The API may be offline.",
    footerSource: "Sources:",
    footerLegal:
      " · CPC & Lanka IOC · newer revision wins · Checked 5× daily · Independent, not affiliated.",
  },
  mobile: {
    label92: "Petrol 92 · official",
    shareWhatsApp: "Share",
    alertsShort: "Alerts",
    waLine:
