...
export function HeroBackground() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      // Transparent fill — body gradient shows through
      ...
      for (let i = 0; i < rows; i++) {
        for (let j = 0; j < cols; j++) {
          ...
          if (cell.alive && cell.opacity < 1) {
            cell.opacity = Math.min(cell.opacity + transitionSpeed, 0.35);
  ...
  return (
    <div className="hero-mask pointer-events-none select-none overflow-hidden">
